...
export default class Topbar extends React.Component {
  ...
  //   this.setState({ swaggerFile: fileToLoad })
  ...
  importFromFile = () => {
    Renderer.openDialog((filePath) => {
      Renderer.setTitle(filePath)
      window.localStorage.setItem('swagger-editor-file-path', filePath)
      let textFromFileLoaded = Renderer.readFileSync(filePath)
      this.props.specActions.updateSpec(YAML.safeDump(YAML.safeLoad(textFromFileLoaded)))
    })
  }

  saveFile = () => {
    let editorContent = window.editorContent || this.props.specSelectors.specStr()
    if (window.localStorage.getItem('swagger-editor-file-path')) {
      Renderer.writeFile(window.localStorage.getItem('swagger-editor-file-path'), editorContent, () => {
        ...
        <div className="topbar">
          <div className="topbar-wrapper">
            ...
            <DropdownMenu {...makeMenuOptions("File")}>
              ...
              <li role="separator"></li>
              <li><button type="button" onClick={this.saveFile}>Save</button></li>
              <li role="separator"></li>
